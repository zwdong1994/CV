...
\begin{itemize}
\item Bo Mao, \underline {Weidong Zhu}, Suzhen Wu and Hong Jiang. {\bf EaD: a Collision-free and High Performance Deduplication Scheme for Flash Storage Systems}. (In Submission, 2018)
\end{itemize}
...
\begin{itemize}
\item Suzhen Wu, \underline {Weidong Zhu}, Hong Jiang, and Bo Mao. {\bf GC-Steering: GC-aware Request Steering with Improved Performance and Reliability for SSD-based RAIDs}. IEEE Transactions on Parallel and Distributed Systems. (In Submission)
\end{itemize}
